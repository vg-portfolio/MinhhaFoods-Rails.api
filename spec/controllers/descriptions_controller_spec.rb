  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Description" do
        expect {
          post :create, params: {description: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved description as @description" do
        post :create, params: {description: invalid_attributes}, session: valid_session
        expect(assigns(:description)).to be_a_new(Description)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested description" do
        description = Description.create! valid_attributes
        put :update, params: {id: description.to_param, description: new_attributes}, session: valid_session
        description.reload
      ...
      it "assigns the requested description as @description" do
        description = Description.create! valid_attributes
        put :update, params: {id: description.to_param, description: valid_attributes}, session: valid_session
        expect(assigns(:description)).to eq(description)
      end
    ...
    context "with invalid params" do
      it "assigns the description as @description" do
        description = Description.create! valid_attributes
        put :update, params: {id: description.to_param, description: invalid_attributes}, session: valid_session
        expect(assigns(:description)).to eq(description)
      end

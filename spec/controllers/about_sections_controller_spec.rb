...
RSpec.describe AboutSectionsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested about_section as @about_section" do
      about_section = AboutSection.create! valid_attributes
      get :show, params: {id: about_section.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested about_section as @about_section" do
      about_section = AboutSection.create! valid_attributes
      get :edit, params: {id: about_section.to_param}, session: valid_session
      expect(assigns(:about_section)).to eq(about_section)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new AboutSection" do
        expect {
          post :create, params: {about_section: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved about_section as @about_section" do
        post :create, params: {about_section: invalid_attributes}, session: valid_session
        expect(assigns(:about_section)).to be_a_new(AboutSection)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested about_section" do
        about_section = AboutSection.create! valid_attributes
        put :update, params: {id: about_section.to_param, about_section: new_attributes}, session: valid_session
      ...
      it "assigns the requested about_section as @about_section" do
        about_section = AboutSection.create! valid_attributes
        put :update, params: {id: about_section.to_param, about_section: valid_attributes}, session: valid_session
        expect(assigns(:about_section)).to eq(about_section)
      end
    ...
    context "with invalid params" do
      it "assigns the about_section as @about_section" do
        about_section = AboutSection.create! valid_attributes
        put :update, params: {id: about_section.to_param, about_section: invalid_attributes}, session: valid_session
        expect(assigns(:about_section)).to eq(about_section)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested about_section" do
      about_section = AboutSection.create! valid_attributes
      expect {
        delete :destroy, params: {id: about_section.to_param}, session: valid_session
      }.to change(AboutSection, :count).by(-1)
    end
